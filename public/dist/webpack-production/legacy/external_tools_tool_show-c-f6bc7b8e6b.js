(window.canvasWebpackJsonp=window.canvasWebpackJsonp||[]).push([[309,560,563,619],{"+dCS":function(e,t,n){"use strict"
...
return t.length<=0&&1===s()(".tool_content_wrapper").length&&(t=s()(".tool_content_wrapper")),t}resize_tool_content_wrapper(e,t){let n=e
"number"!=typeof n&&(n=this.minToolHeight),(t||this.tool_content_wrapper()).height(!e||this.minToolHeight>n?this.minToolHeight:n)}}},"0YqI":function(e,t,n){"use strict"
n.r(t),n.d(t,"whitelist",(function(){return i}))
const i=["requestFullWindowLaunch","lti.resourceImported"]},"0crz":function(e,t,n){"use strict"
var i=n("ouhR"),s=n.n(i),o=n("pQTu"),a=n("m0r6")
...
n("jQeR"),n("0sPK")
var r,l,c=o.default.scoped("lib.text_helper"),u=n("5Ky4")
r=/\b((?:https?:\/\/|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\([^\s()<>]*\))+(?:\([^\s()<>]*\)|[^\s`!()\[\]{};:'".,<>?«»“”‘’]))|(LINK-PLACEHOLDER)/gi
t.a=l={quoteClump:function(e){return"<div class='quoted_text_holder'> <a href='#' class='show_quoted_text_link'>"+Object(u.a)(c.t("quoted_text_toggle","show quoted text"))+"</a> <div class='quoted_text' style='display: none;'> "+s.a.raw(e.join("\n"))+" </div> </div>"},formatMessage:function(e){var t,n,i,s,o,a,c,d
for(s=[],o=[],e=e.replace(r,(function(e,t){var n
return o.push("LINK-PLACEHOLDER"===e?"LINK-PLACEHOLDER":("http://"!==(n=e).slice(0,7)&&"https://"!==n.slice(0,8)&&(n="http://"+n),s.push(n),"<a href='"+Object(u.a)(n)+"'>"+Object(u.a)(e)+"</a>")),"LINK-PLACEHOLDER"})),a=[],c=[],t=0,n=(d=(e=(e=(e=Object(u.a)(e)).replace(new RegExp("LINK-PLACEHOLDER","g"),(function(e,t){return o.shift()}))).replace(/\n/g,"<br />\n")).split("\n")).length;t<n;t++)(i=d[t]).match(/^(&gt;|>)/)?c.push(i):(c.length&&a.push(l.quoteClump(c)),c=[],a.push(i))
return c.length&&a.push(l.quoteClump(c)),a.join("\n")},delimit:function(e){var t,n,i,s,o
if(isNaN(e))return String(e)
if(o=e<0?"-":"",Infinity===(t=Math.abs(e)))return String(e)
for(s=t===(n=Math.floor(t))?"":String(t).replace(/^\d+\./,".");n>=1e3;)i=String(n).replace(/\d+(\d\d\d)$/,",$1"),n=Math.floor(n/1e3),s=i+s
return o+String(n)+s},truncateText:function(e,t){var n,i,s,o,a,r
if(null==t&&(t={}),i=null!=(o=t.max)?o:30,n=c.t("ellipsis","..."),r=c.t("word_separator"," "),!(e=(null!=e?e:"").replace(/\s+/g,r).trim())||e.length<=i)return e
for(a=0;!((s=e.indexOf(r,a+1))<0||s>i-n.length);)a=s
return a||(a=i-n.length),e.substring(0,a)+n},plainText:function(e){return e.replace(/(<([^>]+)>)/gi,"")}}},"9cv0":function(e,t,n){var i={"./__tests__/handleLtiPostMessages.test.js":["Af1U",630],"./__tests__/lti.resourceImported.test.js":["yySz",566],"./__tests__/requestFullWindowLaunch.test.js":["w8Zi",567],"./handleLtiPostMessage.js":["y+46"],"./lti.resourceImported.js":["75OS",631],"./messageTypes.js":["0YqI"],"./requestFullWindowLaunch.js":["S3m7",632]}
function s(e){if(!n.o(i,e))return Promise.resolve().then((function(){var t=new Error("Cannot find module '"+e+"'")
throw t.code="MODULE_NOT_FOUND",t}))
var t=i[e],s=t[0]
return Promise.all(t.slice(1).map(n.e)).then((function(){return n(s)}))}s.keys=function(){return Object.keys(i)},s.id="9cv0",e.exports=s},B1vq:function(e,t,n){"use strict"
var i=n("ouhR"),s=n.n(i)
n("s/PJ")
...
this.each((function(){try{return e=s()(this).offset(),!1}catch(e){}})),r-=e.top,l-=e.top,c-=e.left,u-=e.left}return"HTML"!=this[0].tagName&&"BODY"!=this[0].tagName||(h=s()(window).height(),s()("#wizard_box:visible").length>0&&(h-=s()("#wizard_box:visible").height()),f=s()(window).width(),r-=d,c-=_,l-=d,u-=_),r<0||h<a&&l>h?t.scrollTop=r+d:l>h&&(t.scrollTop=l+d-h+20),c<0?t.scrollLeft=c+_:u>f&&(t.scrollLeft=u+_-f+20),1==t.scrollTop&&(t.scrollTop=0),1==t.scrollLeft&&(t.scrollLeft=0),this.scrollTop(t.scrollTop),this.scrollLeft(t.scrollLeft),this}},gQNp:function(e,t,n){"use strict"
n.r(t)
var i=n("ouhR"),s=n.n(i),o=(n("5Ky4"),n("hiU6")),a=(n("/j35"),n("oMlh")),r=n("+dCS"),l=n("uErj")
const c=s()("#tool_form"),u=function(){c.attr("target","_blank"),function(){const e=c.find("button")
c.show(),e.attr("disabled",!1),setTimeout(()=>{e.attr("disabled",!0).text(e.data("expired_message"))},15e4),c.submit((function(){s()(this).find(".load_tab,.tab_loaded").toggle()}))}()}
switch(c.data("tool-launch-type")){case"window":c.show(),u()
break
case"self":c.removeAttr("target")
try{c.submit()}catch(e){}break
default:try{c.submit()}catch(e){}s()("#tool_content").bind("load",()=>{("https:"!==document.location.protocol||s()("#tool_form")[0].action.indexOf("https:")>-1)&&(s()("#insecure_content_msg").hide(),c.hide())}),setTimeout(()=>{s()("#insecure_content_msg").is(":visible")&&(s()("#load_failure").show(),u())},3e3)}const d=c.data("tool-id")||"unknown",_=c.data("tool-path"),h=c.data("message-type")||"tool_launch"
let f,p
Object(o.a)(h,d,_),s()((function(){const e=s()(window)
f=s()(".tool_content_wrapper")
const t=new r.a(void 0),n=(s()("iframe#tool_content"),f.find(".before_external_content_info_alert, .after_external_content_info_alert"))
n.on("focus",(function(e){f.find("iframe").css("border","2px solid #008EE2"),s()(this).removeClass("screenreader-only-tool")})),n.on("blur",(function(e){f.find("iframe").css("border","none"),s()(this).addClass("screenreader-only-tool")})),s()("body").hasClass("ic-full-screen-lti-tool")||(p=f.offset().top+s()("#footer").outerHeight(!0)),f.length&&!s()("body").hasClass("ic-full-screen-lti-tool")&&e.resize(()=>{f.data("height_overridden")||t.resize_tool_content_wrapper(e.height()-p-s()("#sequence_footer").outerHeight(!0))}).triggerHandler("resize"),null!=ENV.LTI&&null!=ENV.LTI.SEQUENCE&&s()("#module_sequence_footer").moduleSequenceFooter({assetType:"Lti",assetID:ENV.LTI.SEQUENCE.ASSET_ID,courseID:ENV.LTI.SEQUENCE.COURSE_ID}),s()("#content").on("click","#mark-as-done-checkbox",(function(){a.a.toggle(this)}))})),Object(l.a)()},oMlh:function(e,t,n){"use strict"
var i=n("ouhR"),s=n.n(i)
n("jYyc")
t.a={toggle(e){const t=s()(e).data.bind(s()(e))
return s.a.ajaxJSON(t("url"),t("isChecked")?"DELETE":"PUT",{},()=>{t("isChecked",!t("isChecked")),s()(e).toggleClass("btn-success"),s()("i",e).toggleClass("icon-empty icon-complete"),s()(".mark-done-labels span",e).toggleClass("visible")})}}},p6Wi:function(e,t,n){"use strict"
...
n("jQeR"),n("0sPK")
var o=i.default.scoped("instructure_misc_plugins"),a=n("ouhR"),r=n.n(a),l=n("5Ky4"),c=n("JD5e")
n("jYyc"),n("YGE8"),n("B1vq"),n("s/PJ")
r.a.fn.setOptions=function(e,t){let n=e?"<option value=''>"+Object(l.a)(e)+"</option>":""
return null==t&&(t=[]),t.forEach(e=>{const t=Object(l.a)(e)
...
i.authenticity_token=Object(c.a)(),r.a.ajaxJSON(e.url,"DELETE",i,n=>{e.success.call(t,n)},(n,i,s,o)=>{e.error&&r.a.isFunction(e.error)?e.error.call(t,n,i,s,o):r.a.ajaxJSON.unhandledXHRs.push(i)})}else e.success||(e.success=function(){t.fadeOut("slow",()=>{t.remove()})}),e.success.call(t)
...
t=r()(document.createElement("div")),t.css({width:i+6,height:s+6,top:n.top-3,left:n.left-3,zIndex:o+1,position:"absolute",display:"block","-moz-border-radius":5,opacity:.8,border:"2px solid #870",backgroundColor:"#fd0"}),t.addClass("indicator_box"),t.mouseover((function(){r()(this).stop().fadeOut("fast",(function(){r()(this).remove()}))})),this.data("indicator")&&this.indicate("remove"),this.data("indicator",t),r()("body").append(t),e&&e.singleFlash?t.hide().fadeIn().animate({opacity:.8},500).fadeOut("slow",(function(){r()(this).remove()})):t.hide().fadeIn().animate({opacity:.8},500).fadeOut("slow").fadeIn("slow").animate({opacity:.8},2500).fadeOut("slow",(function(){r()(this).remove()})),e&&e.scroll&&r()("html,body").scrollToVisible(t)},r.a.fn.hasScrollbar=function(){return this.length&&this[0].clientHeight<this[0].scrollHeight},r.a.fn.log=function(e){return console.log("%s: %o",e,this),this},r.a.fn.fillWindowWithMe=function(e){const t=r.a.extend({minHeight:400},e),n=r()(this),i=r()("#wrapper"),s=r()("#main"),o=r()("#not_right_side"),a=r()(window),l=r()(this).add(t.alsoResize)
function c(){l.height(0)
const e=a.height()-(i.offset().top+i.outerHeight())+(s.height()-o.height()),c=Math.max(400,e)
l.height(c),r.a.isFunction(t.onResize)&&t.onResize.call(n,c)}return c(),a.unbind("resize.fillWindowWithMe").bind("resize.fillWindowWithMe",c),this},r.a.fn.autoGrowInput=function(e){return e=r.a.extend({maxWidth:1e3,minWidth:0,comfortZone:70},e),this.filter("input:text").each((function(){let t=e.minWidth||r()(this).width(),n="",i=r()(this),s=r()("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:i.css("fontSize"),fontFamily:i.css("fontFamily"),fontWeight:i.css("fontWeight"),letterSpacing:i.css("letterSpacing"),whiteSpace:"nowrap"})
...
var i=n("ouhR"),s=n.n(i),o=n("GLiE"),a=n.n(o),r=n("5Ky4"),l=n("pQTu"),c=n("m0r6")
...
const d={translateMathmlForScreenreaders(e){const t=s()("<div/>").html(e.attr("x-canvaslms-safe-mathml")).html(),n=s()('<span class="hidden-readable"></span>')
return n.html(t),n},toMediaCommentLink(e){const t=s()("<a\n        id='media_comment_".concat(Object(r.a)(s()(e).data("media_comment_id")),"'\n        data-media_comment_type='").concat(Object(r.a)(s()(e).data("media_comment_type")),"'\n        class='instructure_inline_media_comment ").concat(Object(r.a)(e.nodeName.toLowerCase()),"_comment'\n        data-alt='").concat(Object(r.a)(s()(e).attr("data-alt")),"'\n      />"))
return t.html(s()(e).html()),t},convert(e,t={}){const n=s()("<div />").html(e)
return n.find("video.instructure_inline_media_comment,audio.instructure_inline_media_comment").replaceWith((function(){return d.toMediaCommentLink(this)})),n.find("object.instructure_user_content:not(#kaltura_player) embed").remove(),t.forEditing||(n.find("object.instructure_user_content,embed.instructure_user_content").replaceWith((function(){const e=s()(this)
...
return i.append(s()("<input type='hidden'/>").attr({name:"object_data",value:e.data("uc_snippet")})),i.append(s()("<input type='hidden'/>").attr({name:"s",value:e.data("uc_sig")})),s()("body").append(i),setTimeout(()=>i.submit(),0),s()("<iframe\n            class='user_content_iframe'\n            name='".concat(Object(r.a)(t),"'\n            style='width: ").concat(Object(r.a)(e.data("uc_width")),"; height: ").concat(Object(r.a)(e.data("uc_height")),";'\n            frameborder='0'\n            title='").concat(Object(r.a)(u.t("User Content")),"'\n          />"))})),n.find("img.equation_image").each((e,t)=>{const n=s()(t),i=d.translateMathmlForScreenreaders(n)
n.removeAttr("x-canvaslms-safe-mathml"),n.after(i)})),n.html()}}
t.a=d},uErj:function(e,t,n){"use strict"
n.d(t,"a",(function(){return _}))
var i=n("ouhR"),s=n.n(i),o=(n("MWZS"),n("5Ky4")),a=n("+dCS"),r=n("y+46")
let l
function c(){l&&(window.removeEventListener("beforeunload",l),l=null)}function u(e){const t=document.getElementsByTagName("IFRAME")
for(let n=0;n<t.length;n+=1)if(t[n].contentWindow===e)return t[n]
return null}function d(e){var t
if(e.data.messageType)Object(r.default)(e)
else try{const i=JSON.parse(e.data)
switch(i.subject){case"lti.frameResize":const r=new a.a
var n=i.height
n<=0&&(n=1)
const d=r.tool_content_wrapper(i.token||e.origin).data("height_overridden",!0)
if(d.length>0)r.resize_tool_content_wrapper(n,d)
else{const t=u(e.source)
t&&("number"==typeof n&&(n+="px"),t.height=n,t.style.height=n)}break
case"lti.fetchWindowSize":{const t=u(e.source)
if(t){i.height=window.innerHeight,i.width=window.innerWidth,i.offset=s()(".tool_content_wrapper").offset(),i.footer=s()("#fixed_bottom").height()||0,i.scrollY=window.scrollY
const e=JSON.stringify(i)
t.contentWindow.postMessage(e,"*")}break}case"lti.showModuleNavigation":!0!==i.show&&!1!==i.show||s()(".module-sequence-footer").toggle(i.show)
break
case"lti.scrollToTop":s()("html,body").animate({scrollTop:s()(".tool_content_wrapper").offset().top},"fast")
break
case"lti.setUnloadMessage":t=Object(o.a)(i.message),c(),l=function(e){return e.returnValue=t||""},window.addEventListener("beforeunload",l)
break
case"lti.removeUnloadMessage":c()
break
case"lti.screenReaderAlert":s.a.screenReaderFlashMessageExclusive(i.body.html||i.body)
break
case"lti.enableScrollEvents":{const t=u(e.source)
if(t){let e
window.addEventListener("scroll",()=>{e&&window.cancelAnimationFrame(e),e=window.requestAnimationFrame(()=>{const e=JSON.stringify({subject:"lti.scroll",scrollY:window.scrollY})
t.contentWindow.postMessage(e,"*")})},!1)}break}}}catch(e){(console.error||console.log).call(console,"invalid message received from")}}function _(){window.addEventListener("message",e=>{""!==e.data&&d(e)})}},"y+46":function(e,t,n){"use strict"
n.r(t),n.d(t,"ltiState",(function(){return s}))
var i=n("0YqI")
const s={}
t.default=async e=>{const t=e.data,s=t.messageType,o=t.data
let a
if(!i.whitelist.includes(s))return console.error("invalid messageType: ".concat(s)),!1
try{return a=(await n("9cv0")("./".concat(s,".js"))).default,a(o),!0}catch(e){console.error('Error loading or executing message handler for "'.concat(s,'"'),e)}}}}])

//# sourceMappingURL=external_tools_tool_show-c-f6bc7b8e6b.js.map