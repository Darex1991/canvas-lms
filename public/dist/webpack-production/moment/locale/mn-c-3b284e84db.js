(window.canvasWebpackJsonp=window.canvasWebpackJsonp||[]).push([[413],{lYtQ:function(e,s,a){!function(e){"use strict"
function s(e,s,a,t){switch(a){case"s":return s?"хэдхэн секунд":"хэдхэн секундын"
case"ss":return e+(s?" секунд":" секундын")
case"m":case"mm":return e+(s?" минут":" минутын")
case"h":case"hh":return e+(s?" цаг":" цагийн")
case"d":case"dd":return e+(s?" өдөр":" өдрийн")
case"M":case"MM":return e+(s?" сар":" сарын")
case"y":case"yy":return e+(s?" жил":" жилийн")
...
default:return e}}})}(a("wd/R"))}}])

//# sourceMappingURL=mn-c-3b284e84db.js.map